...
conf = SparkConf().setAppName("Day2-MapOperations").setMaster("local[*]")
...
# Resolve customers CSV path relative to repo root
...
def parse_customer(line):
    ...
    # use csv.reader to handle commas inside quoted fields
